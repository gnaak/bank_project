<template>
  <div class="bank-recommendation">
    <div class="bank-recommendation-container">
      <div class="selection">
        <label for="bankDropdown">은행 선택 :  &nbsp;</label>
      ...
      <div v-for="product in products" :key="product.dcls_month" class="product-recommendation">
...
const products = store.finlife2;

const unique = new Set()
for (const product of products.result.baseList){
// console.log(product.kor_co_nm)
unique.add(product.kor_co_nm)
}
console.log(unique)
...
const navigateToDeposit = () => {
  router.push({ name: 'Finlife' });
};

const navigateToDeposit2 = () => {
  router.push({ name: 'Finlife2' });
};
